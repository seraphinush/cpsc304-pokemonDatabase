                    ...
                    <div id="pokedex-entry">
                        <?php
                            ...
                            if (array_key_exists('submittname', $_GET)) {
                                echo "runner";
                                //$name = $_GET['typeName'];
                                //$result = $manager->executePlainSQL("SELECT Species_name FROM Species_Type WHERE Type_name='$name'");
                                //$result = $manager->executePlainSQL("SELECT Species_name FROM Species_Type WHERE Type_name='bug'");
                                //printResult($result);
